...
public class MyHomeLabelAdapter extends RecyclerView.Adapter<MyHomeLabelAdapter.MyViewHolder> {
    private Context context;
    private List<String> list;
    private OnItemClickListener onItemClickListener;
    private int pos = -1;

    public MyHomeLabelAdapter(Context context, List<String> list) {
