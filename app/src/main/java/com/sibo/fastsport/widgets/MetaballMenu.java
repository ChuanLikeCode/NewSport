package com.sibo.fastsport.widgets;
...
public class MetaballMenu extends LinearLayout {
     ...
     *
     * @param context The context of the widget, usually passed through the constructor
     * @param attrs   The user-defined attributes specified in the xml. @see values/attrs.xml for the definitions
     * @author Melvin Lobo
     */
     ...
     *
     * @param menuClickListener The MenuClickListener
     * @author Melvin Lobo
     */
     ...
     *
     * @param bRequired True if elevation is required, false otherwise
     * @author Melvin Lobo
     */
     ...
     *
     * @param view The View whose center is to be determined
     * @author Melvin Lobo
     */
     ...
     * Get the length
     *
     * @param x1 Co-ordinate 1
     * @param x2 Co-ordinate 2
     * @author Melvin Lobo
     */
